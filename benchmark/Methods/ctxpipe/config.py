...
# Base directory for ctxpipe (where this config.py is located)
_CTXPIPE_DIR = os.path.dirname(os.path.abspath(__file__))
...
class GlobalConfig:
    ...
    step_timeout = 60
    skip_evaluation = False  # Skip ML evaluation to save time, use external evaluation instead
    ...
    # Use ctxpipe directory for models (not current working directory)
    model_dir: str = os.path.join(_CTXPIPE_DIR, "models", f"{version}")
