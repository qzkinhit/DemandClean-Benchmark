...
# 获取当前脚本所在目录的上级目录路径
sys.path.append('Methods/HoloClean/')
...
from tools.getScore import calculate_accuracy_and_recall, calculate_all_metrics
...
def main():
    ...
    parser.add_argument('--rule_path', type=str, default='../../Data/beers/dc_rules_holoclean.txt',
