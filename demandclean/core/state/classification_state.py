"""
State extractor for classification tasks
========================================
"""
...
class ClassificationStateExtractor(StateExtractor):
    """
    State-feature extractor for classification tasks.

    Uses decision_function or predicted probabilities to compute distance_to_boundary.
    """
    ...
    def extract(self,
        ...
        if is_label_error:
            # Label error: the label is the most important signal, set to 1.0
            feat_imp = 1.0
        ...
        if is_label_error:
            # Label error: use the distance for this sample's first feature as a proxy
    ...
    def get_distance_to_boundary(self,
        ...
        For classification, this uses the model's decision_function or
